...
public abstract class BaseDAOImpl<T extends BaseDTO> implements BaseDAOInt<T> {
	...
	@PersistenceContext //create object of entityManager
	...
	public T findByUniqueKey(String attribute, Object val, UserContext userContext) {
		...
		//create Query with the help of CriteriaBuilder object 
		CriteriaBuilder builder = entityManager.getCriteriaBuilder();

		//Query create on dtoClass and return instance of CriteriaQuery
		CriteriaQuery<T> cq = builder.createQuery(dtoClass);

		//attributes or column qRoot m aa gye h
		Root<T> qRoot = cq.from(dtoClass);

		//qRoot.get(attribute) se loginid nikali jo k key h
		//val = kon c value db m check krvani h
